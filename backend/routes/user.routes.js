...
//Logout Route
router.get('/logout', authUserMiddleware.authUser, userController.logoutController)

router.get('/all', authUserMiddleware.authUser, userController.getAllUsersController)
